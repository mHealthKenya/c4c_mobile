...
public class Constants {
    ...
    //http://ears-api.mhealthkenya.co.ke/api/counties

    public static String COUNTIES = "http://ears-api.mhealthkenya.co.ke/api/counties";
    public static String SUB_COUNTIES = "http://ears-api.mhealthkenya.co.ke/api/sub/counties";
    public static String WARDS = "http://ears-api.mhealthkenya.co.ke/api/wards";
